...
RTM Worker Template could always use more documentation, whether as part of the
official RTM Worker Template docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
Ready to contribute? Here's how to set up `the_visitors` for local development.
